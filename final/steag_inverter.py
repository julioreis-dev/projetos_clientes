...
class Inverter:
    ...
    @staticmethod
    # Method to analize data of equipment inverter
    ...
    @staticmethod
    # Method to merge data and time of equipment inverter
    def readframe(df):
    ...
    @staticmethod
    # Method to create label to each file of equipment inverter
    def stamp(*args):
        if args[2] == 1:
