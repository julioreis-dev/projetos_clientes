...
class Stringbox:
    ...
    @staticmethod
    # Method to analize data of equipment stringbox
    ...
    @staticmethod
    # Method to merge data and time of equipment stringbox
    def readframe(df):
    ...
    @staticmethod
    # Method to create label to each file of equipment stringbox
    def stamp1(*args):
        if args[2] == 1:
